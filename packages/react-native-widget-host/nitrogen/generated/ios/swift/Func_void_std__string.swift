...
/**
 * Wraps a Swift `(_ status: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.widgethost.bridge.swift

  private let closure: (_ status: String) -> Void

  public init(_ closure: @escaping (_ status: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(status: std.string) -> Void {
    self.closure(String(status))
  }
