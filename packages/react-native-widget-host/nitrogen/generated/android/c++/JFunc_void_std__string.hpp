...
namespace margelo::nitro::widgethost {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/widgethost/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/widgethost/Func_void_std__string_cxx;";
