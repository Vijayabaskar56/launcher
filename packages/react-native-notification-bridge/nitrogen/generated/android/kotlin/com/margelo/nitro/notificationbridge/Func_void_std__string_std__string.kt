...
/**
 * Represents the JavaScript callback `(packageName: string, key: string) => void`.
...
fun interface Func_void_std__string_std__string: (String, String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(packageName: String, key: String): Unit
}
...
class Func_void_std__string_std__string_cxx: Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(packageName: String, key: String): Unit
    = invoke_cxx(packageName,key)

  @FastNative
  private external fun invoke_cxx(packageName: String, key: String): Unit
}
...
class Func_void_std__string_std__string_java(private val function: (String, String) -> Unit): Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(packageName: String, key: String): Unit {
    return this.function(packageName, key)
  }
}
