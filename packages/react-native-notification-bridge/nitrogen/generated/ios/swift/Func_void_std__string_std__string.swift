...
/**
 * Wraps a Swift `(_ packageName: String, _ key: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ packageName: String, _ key: String) -> Void

  public init(_ closure: @escaping (_ packageName: String, _ key: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(packageName: std.string, key: std.string) -> Void {
    self.closure(String(packageName), String(key))
  }
