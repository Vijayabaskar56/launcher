...
- For Reanimated config: treat slider changes as _config updates_ and re-trigger the animation when you want to apply them.
...
return (
  <>
    <Animated.View
      style={[{ height: 60, width: 60, backgroundColor: "black" }, style]}
    />
